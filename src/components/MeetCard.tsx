  ...
  return (
    <div className="w-full max-w-114 lg:w-114 rounded-4xl p-1 bg-linear-to-b from-[#3490C9] to-[#FFFFFF] mt-18 relative mx-auto md:mx-0">
      <div className="w-full h-full rounded-4xl p-2 md:p-4 lg:p-8 bg-linear-to-r from-[#1d01b9] to-[#060124]">
        <div>
          <span className="max-sm:text-md py-2 px-6 md:px-10 tracking-widest text-xl md:text-2xl bg-white text-black font-semibold rounded-2xl absolute top-0 right-1/2 -translate-y-1/2 translate-x-1/2">
            Offering
          </span>
          <div>
            <div className="list-none flex flex-col gap-2  bg-linear-to-r from-[#FFFFFF] via-[#173AED] via-[#ED2222] to-[#D2E5F2] p-px rounded-2xl lg:mt-4">
              <div className="list-none flex flex-col gap-2 md:gap-4 bg-linear-to-r from-[#000001] to-[#0F0067] p-4 md:p-8 rounded-2xl">
                {subProduct.map((item, idx) => (
                  ...
                  >
                    <div
                      key={idx}
                      className="w-full flex justify-between items-center gap-4 py-p md:py-2 px-4 rounded-4xl bg-linear-to-r from-[#000001] to-[#0F0067] md:px-6"
                    >
                      <p className="max-sm:text-md text-xl md:text-2xl font-semibold">
                        {item.product}
                      </p>
                      <span>
                        <Image
                ...
                <button className="w-full text-lg md:mt-4 py-2 uppercase bg-white rounded-2xl text-black md:text-2xl font-bold px-2">
